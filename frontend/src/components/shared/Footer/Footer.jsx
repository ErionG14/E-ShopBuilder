...
const Footer = () => {
  return (
    <footer className="bg-gray-900 border-t border-gray-800 font-inter">
      <div className="container px-8 py-16 mx-auto">
        <div className="flex flex-wrap justify-between gap-10">
          {/* Brand Section */}
          <div className="w-full xl:w-1/4">
            <Link to="/" className="block mb-6">
              <div className="text-2xl font-black text-white tracking-tighter leading-tight">
                E-ShopBuilder by <br />
                <span className="text-blue-500 font-black">VOLTX SYSTEMS</span>
              </div>
            </Link>
            <p className="text-gray-500 text-sm leading-relaxed text-justify">
              The ultimate microservices-powered ecosystem for modern commerce.
              Deploy your storefront, manage inventory with edge precision, and
              scale globally using our distributed architecture.
            </p>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 text-xs uppercase tracking-widest font-bold">
            &copy; {new Date().getFullYear()} VoltX Systems. All rights
            reserved.
          </p>
