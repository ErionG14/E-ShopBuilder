        ...
        <div className="container px-4 mx-auto">
          <div className="-mx-4 flex flex-wrap justify-between">
            ...
            <div className="px-4 my-4 w-full sm:w-auto">
              <div>
                <h2 className="inline-block text-2xl pb-4 mb-4 border-b-2 border-blue-600">Company</h2>
              </div>
            ...
            <div className="px-4 my-4 w-full sm:w-auto">
              <div>
                <h2 className="inline-block text-2xl pb-4 mb-4 border-b-2 border-blue-600">Blog</h2>
              </div>
              <ul className="leading-8">
                <li><a href="#" className="hover:text-white transition-colors duration-300">Getting Started With HTML and CSS</a></li>
                <li><a href="#" className="hover:text-white transition-colors duration-300">What Is Flex And When to Use It?</a></li>
                <li><a href="#" className="hover:text-white transition-colors duration-300">How TailwindCSS Can Help Your Productivity?</a></li>
                <li><a href="#" className="hover:text-white transition-colors duration-300">5 Tips to Make Responsive Website</a></li>
                <li><a href="#" className="hover:text-white transition-colors duration-300">See More</a></li>
              </ul>
            </div>
            <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
              <div>
                <h2 className="inline-block text-2xl pb-4 mb-4 border-b-2 border-blue-600">Connect With Us</h2>
              </div>
